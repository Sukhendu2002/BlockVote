...
function NavbarAdmin() {
  ...
  return (
    <Container className="header-fixed border-b-2 flex justify-between bg-[#23598f] dark:bg-[#fff] px-4">
      <Link
        to="/"
        className="text-[#0168CF] font-extrabold text-5xl hover:text-[#65aded] "
      >
      ...
      <div className=" flex justify-between items-center">
        <Link
          className={`py-2 px-4 rounded-lg   bg-[#fff] text-[#000000] hover:text-[#65aded] hover:underline font-bold mx-2 ${
            verify && "border-b-4 border-[#0168CF]"
          }`}
          to="/Verification"
          onClick={closeMenu}
        >
        ...
        <Link
          className={`py-2 px-4 rounded-lg   bg-[#fff] text-[#000000] hover:text-[#65aded] hover:underline font-bold mx-2 ${
            addCandidate && "border-b-4 border-[#0168CF]"
          }`}
          smooth
          to="/AddCandidate"
          onClick={closeMenu}
