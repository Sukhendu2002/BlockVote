...
import { setAllRegisteredVoters } from "../../../reducer/electionSlice";
  ...
  return (
    <Container>
      ...
      <div className="container-main">
        <h3 className="text-7xl text-[#0168CF] mb-4">Verification</h3>
        <small className="text-[#0168CF] text-5xl mt-4">
          Total Voters: {voterCount || 0}
        </small>
        {voterCount < 1 ? (
          <div className="text-4xl mt-4">🗳️ No voter registered yet.</div>
        ) : (
          <>
