...
import {
  ...
  setVerify,
  setVoting,
} from "../../../reducer/checkSlice";
import { setAllRegisteredCanidates } from "../../../reducer/electionSlice";
const AddCandidate = () => {
  ...
  useEffect(() => {
    dispatch(setAllRegisteredCanidates(candidates));
  }, [candidates]);
    ...
    <>
      {web3 ? (
        <Container>
          ...
          {isAdmin ? (
            <>
              <small className="text-5xl font-medium font-sans text-[#234975] hover:cursor-pointer hover:text-[#2b66aa]">
                Total Candidates:
                <strong className="text-[#0168CF] hover:no-underline">
                  {" "}
                  {candidateCount}
                </strong>
              </small>
              <div className=" w-1/2 m-auto shadow-[#c6c4c4] shadow-inner pt-4">
                ...
                <div className="flex items-center w-3/4 m-auto">
                  <hr
                    className="w-1/2 text-[#0168CF] 
                    
                  "
                  />
                  <span className="">❌</span>
                  <hr className="w-1/2 text-[#0168CF]" />
                </div>
                <div className="container-item">
                  <form className="form px-8 py-2">
                    <div className="mb-2">
                      ...
                      <input
                        ...
                        className="border-b-2 py-2 items-center text-3xl my-4 border-[#878585] outline-none w-full text-[#0168CF]"
                      />
                    </div>
                    <div className="mb-2">
                      ...
                      <input
                        ...
                        className="border-b-2 items-center py-2 text-3xl m-b-4 border-[#878585] outline-none w-full text-[#0168CF]"
                      />
                    </div>
                    <div className="flex items-center mt-4 mb-2">
                      ...
                      <button
                        className="px-4 py-2 w-[160px] h-[40px] text-lg text-[#ffffff]  bg-[#0168CF] rounded-lg font-bold hover:text-[#fff] hover:bg-[#3d73b2]"
                        disabled={
                          fileImg === null ||
                          imageUploaded === true ||
                          imageLoading === true
          ...
          <div className="container-main mt-6">
            <div className="container-item info">
              <center className="font-bold text-5xl text-[#234975] py-6">
                Candidates List
              </center>
            </div>
            {candidates.length < 1 ? (
              ...
              <div
                className="container-item m-auto flex"
                style={{
                  alignItems: "center",
