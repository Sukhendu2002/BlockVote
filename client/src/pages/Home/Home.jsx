      ...
      <div className="home mt-4">
        ...
        <div className="homeLeft">
          ...
          <p className="font-bold">
            ...
            technology. We provide a secure and transparent voting system with
            blockchain technology.
          </p>
          <div className="flex items-center">
            <button
              onClick={loadWeb3}
              className="flex items-center bg-[#0168CF] text-[#fff] py-2 px-4 rounded-lg mr-6 hover:bg-[#21779c] text-3xl hover:shadow-[0_0_0_1px_rgba(0,0,0,0.3)]"
            >
              Connect to Metamask
              <img
                className="h-16 w-20"
            ...
            <button
              className="flex items-center bg-[#0168CF] text-[#fff] py-2 px-4 rounded-lg h-20 hover:bg-[#337e9e] text-3xl hover:shadow-[0_0_0_1px_rgba(0,0,0,0.3)]"
              onClick={() => {
                document
      ...
      <div className="process" id="process">
        ...
        <div className="allprocess">
          <div className="processCard">
            ...
            <p>
              Register as a voter by providing your details and phone number
            </p>
          </div>
          <div className="processCard">
            <span>2.</span>
        ...
        {!elStarted & !elEnded ? (
          ...
          >
            ...
            >
              {isAdmin ? (
                <>
                  <h3 className="text-5xl">Register Election</h3>
                  <p className="text-3xl mt-2">(Set up the election.)</p>
                </>
              ) : (
                <p
                  style={{
                ...
                >
                  ⏳ Please wait, the election is not started yet. 🗳️
                </p>
              )}
            </center>
          </div>
